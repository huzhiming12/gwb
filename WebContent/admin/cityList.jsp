...
<body>
	...
	<div class="container-fluid" style="min-height: 700px;">
		...
		<div class="row-fluid">
			...
			<div class="span9">
				<h1 class="page-title">城市设置</h1>
				<hr>
				<form action="admin/setting_cityList" method="post">
					<div class="btn-toolbar">
						<div class="input-append">

							<input class="span3" name="pager.condition['keyword']"
								value="<s:property value="pager.condition['keyword']"/>" placeholder="城市名称"
								id="appendedInputButton" type="text">
							<button class="btn" type="submit">搜索</button>

							<button class="btn btn-primary" type="button" onclick="addcity()">
								<i class="icon-plus"></i> 添加城市
							</button>
						</div>
				...
				<div class="well">
					<table class="table table-striped">
						...
						<tbody>
							<s:iterator value="cities" id="c" status="citys">
								<tr>
									<td>
										<s:property value="#citys.index+1" />
									</td>
									<td>
									...
									<td>
										...
										<a href="#myModal" onclick="delId=<s:property value='#c.id'/> " role="button"
											data-toggle="modal">
