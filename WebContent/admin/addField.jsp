...
<body>
		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<div style="width: 100%; text-align: center">
					...
					<p class="text-warning">
						<span>添加的领域将直接加入到领域列表中</span>
					</p>
					<p class="text-warning">
						<span>顾问可以通过领域列表选个自己擅长的领域！</span>
					</p>
				</div>
				<br>
				<form id="my-form" action="admin/setting_addFieldResult" method="post">
					<div style="width: 100%; text-align: center">
						<table style="margin: auto">
							<tr>
								<td style="width: 25%;" height="34" align="center">
									<label class="control-label" for="inputPassword">领域名称:</label>
								</td>
								<td colspan="2" align="center">
									<input style="width: 90%;" id="title" name="field.title" type="text" placeholder="请输入领域名称" />
								</td>
							</tr>

							<tr>
								<td align="center">
									<label class="control-label" for="inputPassword">领域简介:</label>
								</td>
								<td colspan="2" align="center">
									<textarea name="field.description" id="description" placeholder="请输入领域简介" cols="20"
										rows="5"></textarea>
								</td>
							</tr>
	...
	<script type="text/javascript">
		$("#addBtn").click(function() {
			...
			$.post("admin/setting_addFieldResult", {
