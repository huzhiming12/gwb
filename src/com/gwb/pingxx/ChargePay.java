...
{
	private String appId = Config.PING_APP_ID;

	public ChargePay()
	{
	}

	public ChargePay(String appId)
	{
		this.appId = appId;
	}
	...
	public static void runDemos(String appId)
	{
		...
		// ChargePay chargeExample = new ChargePay();
	 ...
	 * @return Charge
	 */
	public Charge createCharge(Map<String, Object> order)
	{
		Charge charge = null;
		Map<String, Object> chargeMap = new HashMap<String, Object>();
		// 订单总金额, 人民币单位：分（如订单总金额为 1 元，此处请填 100）
		chargeMap.put("amount", order.get("amount"));
		chargeMap.put("currency", "cny");
		chargeMap.put("subject", order.get("subject"));
		chargeMap.put("body", order.get("body"));
		// 推荐使用 8-20 位，要求数字或字母，不允许其他字符
		chargeMap.put("order_no", order.get("order_no"));
		// 支付使用的第三方支付渠道取值，请参考：https://www.pingxx.com/api#api-c-new
		chargeMap.put("channel", order.get("channel"));
		// 发起支付请求客户端的 IP 地址，格式为 IPV4，如:127.0.0.1
		chargeMap.put("client_ip", order.get("client_ip"));
	...
	public Charge createChargeWithOpenid(String openid)
	{
		...
		Map<String, Object> extra = new HashMap<String, Object>();
		extra.put("open_id", openid);// 用户在商户微信公众号下的唯一标识，获取方式可参考
