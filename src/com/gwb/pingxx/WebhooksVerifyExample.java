...
{
	private static String pubKeyPath = WebhooksVerifyExample.class.getClassLoader().getResource("").getPath()
			+ "pingpp_public_key.pem";
	...
	public static void runDemos() throws Exception
	{
		...
		// 签名数据请从 request 的 header 中获取, key 为 X-Pingplusplus-Signature (请忽略大小写,
		// 建议自己做格式化)
