...
public class CheckPrivilegeInterceptor extends AbstractInterceptor
{
	public String intercept(ActionInvocation invocation) throws Exception
	{
		...
		if (actionName.endsWith("register")/* 顾问注册 */ || actionName.endsWith("registerResult")/* 顾问注册 */
				|| actionName.endsWith("phoneCheck")/* 检测电话号码是否使用 */
				|| actionName.endsWith("login")/* 用户登录 */ || actionName.endsWith("loginCheck")/* 用户登录检测 */
				|| actionName.startsWith("Alipay_")/* 支付宝返回通知 */
